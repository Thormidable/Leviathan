...
void cMissileLeviathanMk1::CreateData()
{
        Initialise(48,6);
    cMatrix4 lpRelative;
...
cLeviathanTurretSettings *mpTurretSettings=new cLeviathanTurretSettings(cLeviathanComponentSettings(4000.0f,new cFoundationSettingsList(0,cMatrix4()),0,dynamic_cast<cLeviathanReactorSettings*>(mpNodes[LV_TRAIN_REACTOR]),0.5f),"TLevTurretCollection",TRAIN_LEV_TRACK_SPEED,DEGREES_TO_RADIANS(-135),DEGREES_TO_RADIANS(135),DEGREES_TO_RADIANS(-10),DEGREES_TO_RADIANS(90),0.00025f);
cMissileSettings *mpMissileSettings=new cExplosiveMissileSettings(0,"TLevTurretBarrelMesh","TLevTexture",c3DVf(0.0f,-0.5f,1.0f),cGameTarget(),PLAYER_SHIP_FILTER,15.0f,5.0f,0.003f,3000.0f,200.0f,10.0f,0,300.0f,cDamage(300.0f,DAMAGE_TYPE_AREA));
 ...
 mpComponents[liCount++]=new cLeviathanMissileTurretSettings(mpTurretSettings,5000.0f,mpMissileSettings);
...
string cMissileLeviathanMk1::LeviathanName(){return "Missile Leviathan";};
uint8 cMissileLeviathanMk1::LeviathanLevel(){return 0;};
uint32 cMissileLeviathanMk1::LeviathanType(){return 2;};
cTexture *cMissileLeviathanMk1::LeviathanTypeIcon(){return _GET_TEXTURE_FILE("TypeIcon2");};
