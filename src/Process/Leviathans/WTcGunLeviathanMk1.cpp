...
void cGunLeviathanMk1::CreateData()
{
...
string cGunLeviathanMk1::LeviathanName(){return "Gun Leviathan";};
uint8 cGunLeviathanMk1::LeviathanLevel(){return 0;};
uint32 cGunLeviathanMk1::LeviathanType(){return 0;};
cTexture *cGunLeviathanMk1::LeviathanTypeIcon(){return _GET_TEXTURE_FILE("TypeIcon4");};
